class Counter {
    constructor(elem, delay) {
        ...
        var interval;
        let quotes = [
            "'Wisdom is supreme;therefore get wisdom.'King Solomon",
      ...
      let elem = document.getElementById("quotes-switcher");
      
      counter = new Counter(elem, 7000);
      counter.start();
